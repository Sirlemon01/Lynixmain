function Edit()
    ...
    local invitecode = ""
    local HAMEWARE_Chatspam = {"LynIx Cheat ON TOP!"}
    local Furry_Chatspam = {"LynIx Cheat ON TOP!"}
    local Swiss_Chatspam = {"LynIx Cheat ON TOP!"..invitecode}
    local HvH_Chatspam = {"LynIx Cheat ON TOP!"}
    local China_Chatspam = {"LynIx Cheat ON TOP!"}
    local uion = true
    ...
    Lagmode1:addToggle("Anti Lag", nil, function(value)
     ...
     Lagmode1:addToggle("FPS Boost", nil, function(value)
        Fake = value
     end)
